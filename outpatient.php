...
<div id="page">
  ...
  <div id="body">
    ...
    <input type="button" value="Tambah" class="button fl-left" onclick="window.location='add-outpatient.php';" />
    ...
    <table width="100%" border="0" class="datagrid">
		  ...
		  while($row = mysql_fetch_assoc($index)) {
              ...
              <tr>
                ...
                <td align="center">
                	<a title="Edit" href="edit-outpatient.php?id=<?= $row['id']; ?>"><img src="assets/img/edit.png" width="14" /></a> &nbsp; 
