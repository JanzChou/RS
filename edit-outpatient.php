...
<div id="page">
  ...
  <div id="body">
    ...
    <input type="button" class="button fl-right" value="Cetak" onclick="window.open('billing.php?id=<?= $_GET['id']; ?>&medical_service_group_id=1');" />
    
   	<h1>Detail Rawat Jalan</h1>
		...
		<tr>
			...
			<td>
				<select name="doctor_id" class="input" id="doctor_id">
					...
					while($row = mysql_fetch_assoc($index)) {
						if($data['doctor_id'] == $row['id']) { $class = ' selected="selected"'; } else { $class = ''; }
						echo "<option" . $class . " value='$row[id]'>$row[name], $row[specialist_title] - $row[specialist_name]</option>";
					}
					include('lib/close.php');
					?>
			  	</select>
            ...
            <tr>
              ...
              <td>
                ...
                <input type="reset" value="Kembali" class="button" onclick="window.location='outpatient.php'" />
    	...
    	<table width="100%" border="0" class="datagrid">
		  ...
		  ?>
          	<tr>
                ...
                <td><input name="description" type="text" class="input" autocomplete="off" id="description" size="50" /></td>
                <td align="center">
    	...
    	<table width="100%" border="0" class="datagrid">
		  ...
		  ?>
          	<tr>
                ...
                <td><input name="qty" type="number" class="input" min="1" autocomplete="off" id="qty" size="30" /></td>
                <td align="center">&nbsp;</td>
                <td align="center">
                	<input type="hidden" name="transaction_id" value="<?= $_GET['id']; ?>" />
                    <input type="hidden" name="dispatch" value="add" />
    	...
    	<table width="100%" border="0" class="datagrid">
		  ...
		  ?>
          	<tr>
                ...
                <td><input name="description" class="input" min="1" autocomplete="off" id="description" size="33" /></td>
                <td align="center">&nbsp;</td>
                <td align="center">
                	<input type="hidden" name="transaction_id" value="<?= $_GET['id']; ?>" />
                    <input type="hidden" name="dispatch" value="add" />
    	...
    	<table width="100%" border="0" class="datagrid">
		  ...
		  ?>
          	<tr>
                ...
                <td><input name="description" class="input" min="1" autocomplete="off" id="description" size="15" /></td>
                <td align="center">&nbsp;</td>
                <td align="center">
                	<input type="hidden" name="transaction_id" value="<?= $_GET['id']; ?>" />
                    <input type="hidden" name="dispatch" value="add" />
