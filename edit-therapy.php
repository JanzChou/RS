...
$index = mysql_query("SELECT * FROM therapy WHERE id = " . $_GET['id']);
...
<div id="page">
  ...
  <div id="body">
    ...
    <form method="post" id="formModel" action="action/master-therapy.php">
	<table width="100%" border="0">
		<tr>
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td>
              	<input type="button" value="Simpan" class="button" onclick="return validateMasterTherapy();" />
                <input type="reset" value="Batalkan" class="button" onclick="window.location='therapy.php'" />
