...
$index = mysql_query("SELECT * FROM room_category WHERE id = " . $_GET['id']);
...
<div id="page">
  ...
  <div id="body">
   	<h1>Edit Kategori Kamar</h1>
    
    <form method="post" id="formModel" action="action/master-room-category.php">
	<table width="100%" border="0">
		<tr>
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td>
              	<input type="button" value="Simpan" class="button" onclick="return validateMasterRoomCategory();" />
                <input type="reset" value="Batalkan" class="button" onclick="window.location='room-category.php'" />
