...
<div id="page">
  ...
  <div id="body">
    ...
    <input type="button" value="Tambah" class="button fl-left" onclick="window.location='add-laboratory.php';" />
    ...
    <table width="100%" border="0" class="datagrid">
		  ...
		  while($row = mysql_fetch_assoc($index)) {
              ...
              <tr>
                ...
                <td align="center">
                	<a title="Edit" href="edit-laboratory.php?id=<?= $row['id']; ?>"><img src="assets/img/edit.png" width="14" /></a> &nbsp; 
                    <a title="Hapus" href="delete.php?tbl=laboratory&id=<?= $row['id']; ?>" onclick="return confirmDelete();"><img src="assets/img/delete.png" width="14" /></a>
                </td>
              </tr>  
              <?php
		  }
